...
public class DragLinearLayout extends LinearLayout {
    ...
    public void addDragView(View child) {
        addView(child);
        setViewDraggable(child, handleView);
    }

    public void addDragView(View child, ViewGroup.LayoutParams params) {
    ...
    public void addDragView(View child, int index) {
        addView(child, index);
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        switch (MotionEventCompat.getActionMasked(event)) {
            case MotionEvent.ACTION_DOWN: {
                ...
                /*if ( draggedItem.view instanceof RelativeLayout) {
                    if ("image".equals( draggedItem.view.getTag(R.id.richEditor))) {
                        //继续操作
                    }else {
                        return true;
                    }
                }else if(draggedItem.view instanceof EditText){
                    return true;
                }*/
